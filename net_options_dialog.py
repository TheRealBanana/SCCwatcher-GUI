...
class Ui_netOptionsDialog(object):
    def setupUi(self, netOptionsDialog, context, state_data):
        ...
        self.remoteRadio.setGeometry(QtCore.QRect(10, 5, 111, 21))
        font = QtGui.QFont()
        ...
        self.RSGB_ipHostnameTextbox.setGeometry(QtCore.QRect(122, 32, 186, 20))
        ...
        self.RSGB_portTextbox.setGeometry(QtCore.QRect(122, 62, 41, 20))
    ...
    def accept(self):
        ...
        self.context.setNetworkOptions(net_options)
